      ...
      <div class="modal-body">
        <div class="col">
          <ol>
            ...
            This Policy aims to define the process how <span class="text-primary fw-bold"><span class="text-primary fw-bold">ArchFxGlobe</span></span> collects and processes personal data of the Clients through the use of <span class="text-primary fw-bold"><span class="text-primary fw-bold">ArchFxGlobe</span></span>.com (hereinafter referred to as the “Website”), including any data the Client may provide through the Website when providing or summiting any information thereto. <br>
            <br>
            This Website is not intended for children and no data related to children may be collected.
            <li> DATA CONTROLLER</li>

            <span class="text-primary fw-bold"><span class="text-primary fw-bold">ArchFxGlobe</span></span> is the controller and responsible person/entity for Client’s personal data. It is important that the personal data the Company holds about the Client is accurate and current. The obligation to inform the Company about any changes in personal data will be on Client’s side.
            ...
            In general, the Company does not rely on respective consent, forming a legal basis for processing of Client’s personal data, other than in relation to sending third party direct marketing communications to you via email or text message. The Client has the right to withdraw his consent to marketing purposes at any time by contacting the Company via mail to <span class="text-primary fw-bold"><span class="text-primary fw-bold">Support@ArchFxGlobe.com</span></span>
            <li>PURPOSES FOR WHICH THE COMPANY USES PERSONAL DATA OF THE CLIENTS</li>

            Client’s personal data may be processed for more than one lawful ground depending on the specific purpose for which we are using your data. If necessary, the Client shall contact the Company via mail to <span class="text-primary fw-bold"><span class="text-primary fw-bold">Support@ArchFxGlobe.com</span></span> for the purpose of obtaining necessary details about the specific legal ground the Company relies on to process his personal data where more than one ground has been set out.
            <li>DISCLOSURE OF CLIENT’S PERSONAL DATA</li>

            The Company may share Client‘s personal data with third parties for the purpose of carrying out its services related to <span class="text-primary fw-bold"><span class="text-primary fw-bold">ArchFxGlobe</span></span> properly. Security of Client‘s personal data shall be fully respected by such third parties and treated in accordance with the law. Such Client‘s personal data may not be used by third parties for their own purposes while they may be processed only for specified purposes by the Company and in accordance with Company‘s instructions. Such providers are: <br>
