...
<nav class="navbar navbar-expand-md navbar-dark fixed-top bg-primary fw-bolder onlyhome">{{-- navbar-light navbar-dark --}}
  ...
  <a class="navbar-brand homenavlink" href="#"><img src="../images/fxGlobe.gif" alt="LOGO" style="width:30px;"><span class="text-primary fw-bold">ArchFxGlobe</span></a>
      ...
      <div class="modal-body">
        <div class="col">
          <ol>
            ...
            In general, the Company does not rely on respective consent, forming a legal basis for processing of Client’s personal data, other than in relation to sending third party direct marketing communications to you via email or text message. The Client has the right to withdraw his consent to marketing purposes at any time by contacting the Company via mail to info@<span class="text-primary fw-bold">ArchFxGlobe</span>.com
            <li>PURPOSES FOR WHICH THE COMPANY USES PERSONAL DATA OF THE CLIENTS</li>

            Client’s personal data may be processed for more than one lawful ground depending on the specific purpose for which we are using your data. If necessary, the Client shall contact the Company via mail to info@<span class="text-primary fw-bold">ArchFxGlobe</span>.com for the purpose of obtaining necessary details about the specific legal ground the Company relies on to process his personal data where more than one ground has been set out.
